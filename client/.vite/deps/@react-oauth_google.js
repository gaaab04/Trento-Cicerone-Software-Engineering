	...
	(0, import_react.useEffect)(() => {
		...
		(_c = (_b = (_a = window === null || window === void 0 ? void 0 : window.google) === null || _a === void 0 ? void 0 : _a.accounts) === null || _b === void 0 ? void 0 : _b.id) === null || _c === void 0 || _c.initialize({
			...
			callback: (credentialResponse) => {
				var _a$1;
				if (!(credentialResponse === null || credentialResponse === void 0 ? void 0 : credentialResponse.credential)) return (_a$1 = onErrorRef.current) === null || _a$1 === void 0 ? void 0 : _a$1.call(onErrorRef);
		...
		return () => {
			var _a$1, _b$1, _c$1;
			if (useOneTap) (_c$1 = (_b$1 = (_a$1 = window === null || window === void 0 ? void 0 : window.google) === null || _a$1 === void 0 ? void 0 : _a$1.accounts) === null || _b$1 === void 0 ? void 0 : _b$1.id) === null || _c$1 === void 0 || _c$1.cancel();
		};
	}, [
		clientId,
		scriptLoadedSuccessfully,
...
function useGoogleLogin({ flow = "implicit", scope = "", onSuccess, onError, onNonOAuthError, overrideScope, state,...props }) {
	...
	(0, import_react.useEffect)(() => {
		...
		clientRef.current = (_b = (_a = window === null || window === void 0 ? void 0 : window.google) === null || _a === void 0 ? void 0 : _a.accounts) === null || _b === void 0 ? void 0 : _b.oauth2[clientMethod]({
			...
			callback: (response) => {
				var _a$1, _b$1;
				if (response.error) return (_a$1 = onErrorRef.current) === null || _a$1 === void 0 ? void 0 : _a$1.call(onErrorRef, response);
				(_b$1 = onSuccessRef.current) === null || _b$1 === void 0 || _b$1.call(onSuccessRef, response);
			},
			error_callback: (nonOAuthError) => {
				var _a$1;
				(_a$1 = onNonOAuthErrorRef.current) === null || _a$1 === void 0 || _a$1.call(onNonOAuthErrorRef, nonOAuthError);
			},
			state,
			...props
		});
...
function useGoogleOneTapLogin({ onSuccess, onError, promptMomentNotification, cancel_on_tap_outside, prompt_parent_id, state_cookie_domain, hosted_domain, use_fedcm_for_prompt = false, use_fedcm_for_button = false, disabled, auto_select }) {
	...
	(0, import_react.useEffect)(() => {
		...
		return () => {
			var _a$1, _b$1, _c$1;
			(_c$1 = (_b$1 = (_a$1 = window === null || window === void 0 ? void 0 : window.google) === null || _a$1 === void 0 ? void 0 : _a$1.accounts) === null || _b$1 === void 0 ? void 0 : _b$1.id) === null || _c$1 === void 0 || _c$1.cancel();
		};
	}, [
		clientId,
		scriptLoadedSuccessfully,
